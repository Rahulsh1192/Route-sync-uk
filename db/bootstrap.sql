...
-- Instructor share = 0 at launch (charity + marketing model); full pipeline is
-- present so a share can be enabled later via platform_config alone.
-- ============================================================================
BEGIN;
...
-- ============================================================================
-- PHASE 24 — Dashcam multi-clip upload, video<->GPS sync, map-follows-marker.
-- Clip->wall-clock mapping table (anti-drift), GPS provenance on uploads, the
-- journey<->upload join, and the extensible dashcam format registry.
-- See db/migrate_phase_24.sql for the full rationale.
-- ============================================================================
BEGIN;
